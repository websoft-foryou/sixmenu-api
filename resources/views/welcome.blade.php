...
<head>
    ...
    <link href="{{ asset('/static/css/main.bfb5a153.chunk.css') }}" rel="stylesheet">
</head>
<body>
...
<script src="{{ asset('/static/js/2.44476515.chunk.js') }}"></script>
<script src="{{ asset('/static/js/main.3b2df311.chunk.js') }}"></script>
</body>
</html>
